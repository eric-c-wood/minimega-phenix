...
func Start(opts ...ServerOption) error {
	...
	api.HandleFunc("/experiments/{exp}/vms/{name}/memorySnapshot", MemorySnapVM).Methods("POST", "OPTIONS")
	...
	api.HandleFunc("/topologies/{topo}/vlanAliases", GetVlanAliases).Methods("GET", "OPTIONS")
